...
///         `abi.encode(token0, token1, uint24 feeTier)`. Stateless —
///         executed via delegatecall from the manager. All hook mechanics
///         live in V3StyleYieldHandler; this contract only pins the
///         canonical id.
